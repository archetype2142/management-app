...
class Taxon < ApplicationRecord
  ...
  has_many :prototype_taxons, class_name: 'PrototypeTaxon', dependent: :destroy
  has_many :prototypes, through: :prototype_taxons, class_name: 'Prototype'

  has_many :promotion_rule_taxons, class_name: 'PromotionRuleTaxon', dependent: :destroy
  has_many :promotion_rules, through: :promotion_rule_taxons, class_name: 'PromotionRule'
  ...
  has_one :icon, as: :viewable, dependent: :destroy, class_name: 'TaxonImage'
  ...
  #   fs << Core::ProductFilters.price_filter if Core::ProductFilters.respond_to?(:price_filter)
  #   fs << Core::ProductFilters.brand_filter if Core::ProductFilters.respond_to?(:brand_filter)
  #   fs
  # end
