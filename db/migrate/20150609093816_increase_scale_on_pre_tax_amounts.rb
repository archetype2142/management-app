class IncreaseScaleOnPreTaxAmounts < ActiveRecord::Migration[4.2]
  def change
    ...
    change_column :line_items, :pre_tax_amount, :decimal, precision: 12, scale: 4, default: 0.0, null: false
    change_column :shipments, :pre_tax_amount, :decimal, precision: 12, scale: 4, default: 0.0, null: false
  end
end
