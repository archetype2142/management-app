class PromoOneTwo < ActiveRecord::Migration[4.2]
  def up
    # This migration is just a compressed migration for all previous versions of promo
    return if data_source_exists?(:products_promotion_rules)
