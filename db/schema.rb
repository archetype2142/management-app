...
ActiveRecord::Schema.define(version: 2020_05_15_005015) do
  ...
  create_table "adjustments", id: :serial, force: :cascade do |t|
    ...
    t.index ["adjustable_id", "adjustable_type"], name: "index_adjustments_on_adjustable_id_and_adjustable_type"
    t.index ["eligible"], name: "index_adjustments_on_eligible"
    t.index ["source_id", "source_type"], name: "index_adjustments_on_source_id_and_source_type"
  end
  ...
  create_table "calculators", id: :serial, force: :cascade do |t|
    ...
    t.text "preferences"
    t.datetime "deleted_at"
    t.index ["calculable_id", "calculable_type"], name: "index_calculators_on_calculable_id_and_calculable_type"
    t.index ["deleted_at"], name: "index_calculators_on_deleted_at"
  ...
  create_table "countries", id: :serial, force: :cascade do |t|
    ...
    t.index "lower((iso_name)::text)", name: "index_countries_on_lower_iso_name", unique: true
  ...
  create_table "customer_returns", id: :serial, force: :cascade do |t|
    t.string "number"
    t.integer "stock_location_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["number"], name: "index_customer_returns_on_number", unique: true
    t.index ["stock_location_id"], name: "index_customer_returns_on_stock_location_id"
  end
  ...
  create_table "gateways", id: :serial, force: :cascade do |t|
    ...
    t.index ["test_mode"], name: "index_gateways_on_test_mode"
  end

  create_table "inventory_units", id: :serial, force: :cascade do |t|
    t.string "state"
    ...
    t.index ["original_return_item_id"], name: "index_inventory_units_on_original_return_item_id"
  ...
  create_table "line_items", id: :serial, force: :cascade do |t|
    ...
    t.index ["tax_category_id"], name: "index_line_items_on_tax_category_id"
  ...
  create_table "log_entries", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["source_id", "source_type"], name: "index_log_entries_on_source_id_and_source_type"
  end

  create_table "option_type_prototypes", id: :serial, force: :cascade do |t|
    t.integer "prototype_id"
    t.integer "option_type_id"
    t.index ["option_type_id"], name: "index_option_type_prototypes_on_option_type_id"
    t.index ["prototype_id", "option_type_id"], name: "option_type_prototypes_prototype_id_option_type_id", unique: true
    t.index ["prototype_id"], name: "index_option_type_prototypes_on_prototype_id"
  end
  ...
  create_table "option_value_variants", id: :serial, force: :cascade do |t|
    t.integer "variant_id"
  ...
  create_table "order_promotions", id: :serial, force: :cascade do |t|
    t.integer "order_id"
    t.integer "promotion_id"
    t.index ["order_id"], name: "index_order_promotions_on_order_id"
    t.index ["promotion_id", "order_id"], name: "index_order_promotions_on_promotion_id_and_order_id"
  ...
  create_table "orders", id: :serial, force: :cascade do |t|
    ...
    t.index ["confirmation_delivered"], name: "index_orders_on_confirmation_delivered"
    t.index ["considered_risky"], name: "index_orders_on_considered_risky"
    ...
    t.index ["user_id", "created_by_id"], name: "index_orders_on_user_id_and_created_by_id"
  end

  create_table "payment_capture_events", id: :serial, force: :cascade do |t|
    t.decimal "amount", precision: 10, scale: 2, default: "0.0"
    t.integer "payment_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["payment_id"], name: "index_payment_capture_events_on_payment_id"
  end
  ...
  create_table "payments", id: :serial, force: :cascade do |t|
    ...
    t.index ["source_id", "source_type"], name: "index_payments_on_source_id_and_source_type"
  end
  ...
  create_table "prices", id: :serial, force: :cascade do |t|
    ...
    t.index ["variant_id", "currency"], name: "index_prices_on_variant_id_and_currency"
    t.index ["variant_id"], name: "index_prices_on_variant_id"
  end

  create_table "product_option_types", id: :serial, force: :cascade do |t|
    t.integer "position"
  ...
  create_table "product_promotion_rules", id: :serial, force: :cascade do |t|
    t.integer "product_id"
  ...
  create_table "product_properties", id: :serial, force: :cascade do |t|
    t.string "value"
    t.integer "product_id"
  ...
  create_table "products_taxons", id: :serial, force: :cascade do |t|
    t.integer "product_id"
    t.integer "taxon_id"
    t.integer "position"
  ...
  create_table "promotion_action_line_items", id: :serial, force: :cascade do |t|
    t.integer "promotion_action_id"
    t.integer "variant_id"
    t.integer "quantity", default: 1
    t.index ["promotion_action_id"], name: "index_promotion_action_line_items_on_promotion_action_id"
    t.index ["variant_id"], name: "index_promotion_action_line_items_on_variant_id"
  end

  create_table "promotion_actions", id: :serial, force: :cascade do |t|
    t.integer "promotion_id"
    t.integer "position"
    t.string "type"
    t.datetime "deleted_at"
    t.index ["deleted_at"], name: "index_promotion_actions_on_deleted_at"
    t.index ["id", "type"], name: "index_promotion_actions_on_id_and_type"
    t.index ["promotion_id"], name: "index_promotion_actions_on_promotion_id"
  end

  create_table "promotion_categories", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "code"
  ...
  create_table "promotion_rule_taxons", id: :serial, force: :cascade do |t|
    t.integer "taxon_id"
    t.integer "promotion_rule_id"
    t.index ["promotion_rule_id"], name: "index_promotion_rule_taxons_on_promotion_rule_id"
    t.index ["taxon_id"], name: "index_promotion_rule_taxons_on_taxon_id"
  end

  create_table "promotion_rule_users", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "promotion_rule_id"
  ...
  create_table "promotion_rules", id: :serial, force: :cascade do |t|
    t.integer "promotion_id"
    t.integer "user_id"
  ...
  create_table "property_prototypes", id: :serial, force: :cascade do |t|
    t.integer "prototype_id"
    t.integer "property_id"
  ...
  create_table "prototype_taxons", id: :serial, force: :cascade do |t|
    t.integer "taxon_id"
    t.integer "prototype_id"
    t.index ["prototype_id", "taxon_id"], name: "index_prototype_taxons_on_prototype_id_and_taxon_id"
    t.index ["prototype_id"], name: "index_prototype_taxons_on_prototype_id"
    t.index ["taxon_id"], name: "index_prototype_taxons_on_taxon_id"
  end

  create_table "prototypes", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "refund_reasons", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index "lower((name)::text)", name: "index_refund_reasons_on_lower_name", unique: true
  end
  ...
  create_table "refunds", id: :serial, force: :cascade do |t|
    ...
    t.index ["reimbursement_id"], name: "index_refunds_on_reimbursement_id"
  end

  create_table "reimbursement_credits", id: :serial, force: :cascade do |t|
    t.decimal "amount", precision: 10, scale: 2, default: "0.0", null: false
    t.integer "reimbursement_id"
    t.integer "creditable_id"
    t.string "creditable_type"
    t.index ["creditable_id", "creditable_type"], name: "index_reimbursement_credits_on_creditable_id_and_type"
    t.index ["reimbursement_id"], name: "index_reimbursement_credits_on_reimbursement_id"
  end

  create_table "reimbursement_types", id: :serial, force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
    t.boolean "mutable", default: true
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "type"
    t.index "lower((name)::text)", name: "index_reimbursement_types_on_lower_name", unique: true
    t.index ["type"], name: "index_reimbursement_types_on_type"
  end
  ...
  create_table "reimbursements", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["customer_return_id"], name: "index_reimbursements_on_customer_return_id"
    t.index ["order_id"], name: "index_reimbursements_on_order_id"
  end

  create_table "return_authorization_reasons", id: :serial, force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
    t.boolean "mutable", default: true
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index "lower((name)::text)", name: "index_return_authorization_reasons_on_lower_name", unique: true
  end

  create_table "return_authorizations", id: :serial, force: :cascade do |t|
    t.string "number"
    t.string "state"
    t.integer "order_id"
    t.text "memo"
    ...
    t.index ["number"], name: "index_return_authorizations_on_number", unique: true
    ...
    t.index ["stock_location_id"], name: "index_return_authorizations_on_stock_location_id"
  end
  ...
  create_table "return_items", id: :serial, force: :cascade do |t|
    ...
    t.index ["exchange_variant_id"], name: "index_return_items_on_exchange_variant_id"
    t.index ["inventory_unit_id"], name: "index_return_items_on_inventory_unit_id"
    t.index ["override_reimbursement_type_id"], name: "index_return_items_on_override_reimbursement_type_id"
    t.index ["preferred_reimbursement_type_id"], name: "index_return_items_on_preferred_reimbursement_type_id"
    t.index ["reimbursement_id"], name: "index_return_items_on_reimbursement_id"
  ...
  create_table "shipping_categories", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["name"], name: "index_shipping_categories_on_name"
  end

  create_table "shipping_method_categories", id: :serial, force: :cascade do |t|
    t.integer "shipping_method_id", null: false
    t.integer "shipping_category_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["shipping_category_id", "shipping_method_id"], name: "unique_shipping_method_categories", unique: true
  ...
  create_table "shipping_method_zones", id: :serial, force: :cascade do |t|
  ...
  create_table "shipping_methods", id: :serial, force: :cascade do |t|
    ...
    t.index ["tax_category_id"], name: "index_shipping_methods_on_tax_category_id"
  end
  ...
  create_table "shipping_rates", id: :serial, force: :cascade do |t|
    ...
    t.index ["selected"], name: "index_shipping_rates_on_selected"
    t.index ["shipment_id", "shipping_method_id"], name: "shipping_rates_join_index", unique: true
    ...
    t.index ["tax_rate_id"], name: "index_shipping_rates_on_tax_rate_id"
  end
  ...
  create_table "state_changes", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["stateful_id", "stateful_type"], name: "index_state_changes_on_stateful_id_and_stateful_type"
  end
  ...
  create_table "stock_items", id: :serial, force: :cascade do |t|
    ...
    t.datetime "deleted_at"
    t.index ["backorderable"], name: "index_stock_items_on_backorderable"
  ...
  create_table "stock_locations", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "default", default: false, null: false
    ...
    t.string "admin_name"
    t.index ["active"], name: "index_stock_locations_on_active"
    t.index ["backorderable_default"], name: "index_stock_locations_on_backorderable_default"
    t.index ["country_id"], name: "index_stock_locations_on_country_id"
    t.index ["propagate_all_variants"], name: "index_stock_locations_on_propagate_all_variants"
    t.index ["state_id"], name: "index_stock_locations_on_state_id"
  end

  create_table "stock_movements", id: :serial, force: :cascade do |t|
  ...
  create_table "stock_transfers", id: :serial, force: :cascade do |t|
    t.string "type"
    t.string "reference"
  ...
  create_table "store_credit_categories", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "store_credit_events", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["originator_id", "originator_type"], name: "store_credit_events_originator"
    t.index ["store_credit_id"], name: "index_store_credit_events_on_store_credit_id"
  end

  create_table "store_credit_types", id: :serial, force: :cascade do |t|
    t.string "name"
    t.integer "priority"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["priority"], name: "index_store_credit_types_on_priority"
  end

  create_table "store_credits", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    ...
    t.index ["type_id"], name: "index_store_credits_on_type_id"
  ...
  create_table "stores", id: :serial, force: :cascade do |t|
    ...
    t.index ["default"], name: "index_stores_on_default"
    t.index ["url"], name: "index_stores_on_url"
  end

  create_table "tax_categories", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "description"
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "tax_code"
    t.index ["deleted_at"], name: "index_tax_categories_on_deleted_at"
    t.index ["is_default"], name: "index_tax_categories_on_is_default"
  end
  ...
  create_table "tax_rates", id: :serial, force: :cascade do |t|
    ...
    t.index ["included_in_price"], name: "index_tax_rates_on_included_in_price"
    t.index ["show_rate_in_label"], name: "index_tax_rates_on_show_rate_in_label"
  ...
  create_table "trackers", id: :serial, force: :cascade do |t|
    ...
    t.index ["active"], name: "index_trackers_on_active"
  end
  ...
  create_table "variants", id: :serial, force: :cascade do |t|
    ...
    t.index ["discontinue_on"], name: "index_variants_on_discontinue_on"
    ...
    t.index ["tax_category_id"], name: "index_variants_on_tax_category_id"
    t.index ["track_inventory"], name: "index_variants_on_track_inventory"
  end

  create_table "zone_members", id: :serial, force: :cascade do |t|
    ...
    t.index ["zoneable_id", "zoneable_type"], name: "index_zone_members_on_zoneable_id_and_zoneable_type"
  end
  ...
  create_table "zones", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "kind"
    t.index ["default_tax"], name: "index_zones_on_default_tax"
    t.index ["kind"], name: "index_zones_on_kind"
  end
